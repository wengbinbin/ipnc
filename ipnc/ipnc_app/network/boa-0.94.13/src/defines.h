...
#define URI_STREAM_MPEG4_1		7
#define URI_STREAM_MPEG4_2		8
#define URI_STREAM_MPEG4_3		9

#define URI_STREAM_MPEG4CIF		4
#define URI_STREAM_MPEG4CIF_1		16
#define URI_STREAM_MPEG4CIF_2		17
#define URI_STREAM_MPEG4CIF_3		18



#define URI_STREAM_AVC			5
#define URI_STREAM_AVC_1			10
#define URI_STREAM_AVC_2			11
#define URI_STREAM_AVC_3			12



#define URI_STREAM_AVCCIF		6
#define URI_STREAM_AVCCIF_1		13
#define URI_STREAM_AVCCIF_2		14
#define URI_STREAM_AVCCIF_3		15
