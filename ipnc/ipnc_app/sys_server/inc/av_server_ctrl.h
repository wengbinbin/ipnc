...
typedef struct StreamEnv_t{
	...
	int MotionBlock;
	int nOsdTextLen;
	char osdtext[OSDTEXTLEN];
	char audioinvolume;
	char audiooutvolume;
	char audioSampleRate;
} StreamEnv_t;

extern const unsigned int enc_framerate_day_1_dm365[10][4][4];
extern const unsigned int enc_framerate_day_2_dm365[10][4][4];
extern const unsigned int enc_framerate_day_3_dm365[10][4][4];
extern const unsigned int enc_framerate_night_1_dm365[10][4][4];
extern const unsigned int enc_framerate_night_2_dm365[10][4][4];
extern const unsigned int enc_framerate_night_3_dm365[10][4][4];
extern const unsigned int enc_framerate_day_1_dm368[10][4][4];
extern const unsigned int enc_framerate_day_2_dm368[10][4][4];
extern const unsigned int enc_framerate_day_3_dm368[10][4][4];
extern const unsigned int enc_framerate_night_1_dm368[10][4][4];
extern const unsigned int enc_framerate_night_2_dm368[10][4][4];
extern const unsigned int enc_framerate_night_3_dm368[10][4][4];
