...
int ControlSystemData(unsigned int field, void *data, unsigned int len)
{
	...
	if(len == 0 || data == NULL)
		...
		case SFIELD_SET_TIME:
			printf("SFIELD_SET_TIME Begin\n");
			ret = SetTime(data, len);
			break;
		...
		case SFIELD_SET_HTTPPORT:
                  #if DEBUG==1
			printf("SFIELD_SET_HTTPPORT Begin\n");
                  #endif
		...
		case SFIELD_SET_HISTOGRAM:
			...
			break;
		case SFIELD_SET_GBCE:
			ret = SetSysGBCE(data, len);
			break;
		...
		case SFIELD_SET_VIDEO_MODE:
			...
			break;
		case SFIELD_SET_VIDEOCODECMODE:
			ret = SetSysVideoCodecMode(data, len);
			break;
		...
		case SFIELD_DEL_SCHEDULE:
			...
			break;
            //add by wbb 2014
		case SFIELD_SET_STORAGE:
			ret = SetSysCommon(data, len, SYS_MSG_SET_STORAGE);
			break;
            //add end
		...
		case SFIELD_INIT_IPNCPTZ:
			...
			break;
		case SFIELD_ENABLE_RECCH:
			ret = EnalbeRecCh(data, len);
			break;	
		case SFIELD_GET_PBRECDAY:
			ret = GetPbRecDayData(data, len);
			break;
		case SFIELD_GET_PBRECHOUR:
			ret = GetPbRecHourData(data, len);
			break;
		case SFIELD_START_PLAYBACKCH:
			ret = StartPlaybackCh(data, len);
			break;
		case SFIELD_STOP_PLAYBACKCH:
			ret = StopPlaybackCh(data, len);
			break;
		case SFIELD_PAUSE_PLAYBACKCH:
			ret = PausePlaybackCh(data, len);
			break;
		case SFIELD_RESUME_PLAYBACKCH:
			ret = ResumePlaybackCh(data, len);
			break;
		...
		case SFIELD_SET_PTZ:
			ret = SetSysCommon(data, len, SYS_MSG_SET_PTZ);
			break;
		...
		case SFIELD_SET_RS485:
			...
			break;
		case SFIELD_SET_RS485_DEV_ADD:
			ret = SetSysCommon(data, len, SYS_MSG_SET_RS485_DEV_ADD);
			break;
		case SFIELD_SET_RS485_DEV_DEL:
			ret = SetSysCommon(data, len, SYS_MSG_SET_RS485_DEV_DEL);
			break;
		case SFIELD_SET_RS232:
			ret = SetSysCommon(data, len, SYS_MSG_SET_RS232);
			break;
		case SFIELD_SET_RS232SPEED:
			ret = SetSysCommon(data, len, SYS_MSG_SET_RS232SPEED);
			break;
		case SFIELD_SET_RS232DATABIT:
			ret = SetSysCommon(data, len, SYS_MSG_SET_RS232DATABIT);
			break;
		case SFIELD_SET_RS232STOPBIT:
			ret = SetSysCommon(data, len, SYS_MSG_SET_RS232STOPBIT);
			break;
		case SFIELD_SET_RS232PARITY:
			ret = SetSysCommon(data, len, SYS_MSG_SET_RS232PARITY);
			break;
		case SFIELD_SET_RS232STREAMCTRL:
			ret = SetSysCommon(data, len, SYS_MSG_SET_RS232STREAMCTRL);
			break;
                #endif
                
		case SFIELD_SET_PLC_TCP:
			ret = SetSysCommon(data, len, SYS_MSG_SET_PLC_TCP);
			break;

		case SFIELD_SET_PLC_SERIAL:
			ret = SetSysCommon(data, len, SYS_MSG_SET_PLC_SERIAL);
			break;
		...
		case SFIELD_SET_EXT_ALARM:
			...
			break;
		case SFIELD_SET_DARKBLANK:
			ret = SetSysCommon(data, len, SYS_MSG_SET_DARKBLANK);
			break;
		...
		case SFIELD_SET_SCHEDULE_INFINITE_ENABLE:
			...
			break;
            //******add  by wbb******//
             case SFIELD_SET_PRESETNOTE:
                    printf("-----------------------%s----------\n",data);
                    ret = SetSysCommon(data, len, SYS_MSG_SET_PRESETNOTE);
		default:
			ret = -1;
			break;
	}
