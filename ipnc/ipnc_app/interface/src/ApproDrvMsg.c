...
//add by sxh
int SetChRecEnableMsg(unsigned char nValue)
{
	MSG_BUF msgbuf;
	unsigned char* ptr;
	...
	msgbuf.Des = MSG_TYPE_MSG1;
	msgbuf.Src = PROC_MSG_ID;
	msgbuf.cmd = MSG_CMD_SET_CHRECENABLE;
	ptr = (unsigned char*)&msgbuf.mem_info;
	*ptr = nValue;
	SemWait(hndlApproDrvSem);
	msgsnd( qid,&msgbuf,sizeof(msgbuf)-sizeof(long),0);/*send msg1*/
...
int GetPbRecHourDataMsg(unsigned char* nValue)//add by sxh
{
	MSG_BUF msgbuf;
	unsigned char* ptr;
	printf("GetPbRecHourDataMsg:nValue:%s!\n",nValue);
	...
	msgbuf.Des = MSG_TYPE_MSG1;
	msgbuf.Src = PROC_MSG_ID;
	msgbuf.cmd = MSG_CMD_GET_PBRECHOUR;
	ptr = (unsigned char*)&msgbuf.mem_info;
	memcpy(ptr, nValue, 24*60+1);
	SemWait(hndlApproDrvSem);
	msgsnd( qid,&msgbuf,sizeof(msgbuf)-sizeof(long),0);/*send msg1*/
	msgrcv( qid, &msgbuf,sizeof(msgbuf)-sizeof(long), PROC_MSG_ID, 0);
	ptr = (unsigned char*)&msgbuf.mem_info;
	printf("GetPbRecHourDataMsg Done:ptr:%s!\n",&msgbuf.mem_info);
	memcpy(nValue, &msgbuf.mem_info,24*60+1);
	printf("GetPbRecHourDataMsg Done:nValue:%s!\n",nValue);
	printf("GetPbRecHourDataMsg Done!\n");
	SemRelease(hndlApproDrvSem);
	return msgbuf.ret;
}
int StartPlaybackChMsg(unsigned char* nValue)//add by sxh
{
	MSG_BUF msgbuf;
	unsigned char* ptr;
	printf("StartPlaybackChMsg:nValue=%s\n",nValue);

	memset(&msgbuf,0,sizeof(msgbuf));
	msgbuf.Des = MSG_TYPE_MSG1;
	msgbuf.Src = PROC_MSG_ID;
	msgbuf.cmd = MSG_CMD_START_PLAYBACKCH;
	ptr = (unsigned char*)&msgbuf.mem_info;
	memcpy(ptr, nValue, strlen(nValue));
	printf("StartPlaybackChMsg:ptr=%s\n",ptr);
	SemWait(hndlApproDrvSem);
	msgsnd( qid,&msgbuf,sizeof(msgbuf)-sizeof(long),0);/*send msg1*/
	msgrcv( qid, &msgbuf,sizeof(msgbuf)-sizeof(long), PROC_MSG_ID, 0);
	SemRelease(hndlApproDrvSem);
...
int StopPlaybackChMsg(unsigned char* nValue)//add by sxh
{
	MSG_BUF msgbuf;
	unsigned char* ptr;
	...
	msgbuf.Des = MSG_TYPE_MSG1;
	msgbuf.Src = PROC_MSG_ID;
	msgbuf.cmd = MSG_CMD_STOP_PLAYBACKCH;
	ptr = (unsigned char*)&msgbuf.mem_info;
	memcpy(ptr, nValue, strlen(nValue));
	printf("StopPlaybackChMsg:ptr=%s\n",ptr);
	SemWait(hndlApproDrvSem);
	msgsnd( qid,&msgbuf,sizeof(msgbuf)-sizeof(long),0);/*send msg1*/
	msgrcv( qid, &msgbuf,sizeof(msgbuf)-sizeof(long), PROC_MSG_ID, 0);
	SemRelease(hndlApproDrvSem);
...
int PausePlaybackChMsg(unsigned char* nValue)//add by sxh
{
	MSG_BUF msgbuf;
	unsigned char* ptr;
	...
	msgbuf.Des = MSG_TYPE_MSG1;
	msgbuf.Src = PROC_MSG_ID;
	msgbuf.cmd = MSG_CMD_PAUSE_PLAYBACKCH;
	printf("PausePlaybackChMsg:nValue=%s,len=%d\n",nValue,strlen(nValue));
	ptr = (unsigned char*)&msgbuf.mem_info;
	memcpy(ptr, nValue, strlen(nValue));
	printf("PausePlaybackChMsg:ptr=%s\n",ptr);
	SemWait(hndlApproDrvSem);
	msgsnd( qid,&msgbuf,sizeof(msgbuf)-sizeof(long),0);/*send msg1*/
	msgrcv( qid, &msgbuf,sizeof(msgbuf)-sizeof(long), PROC_MSG_ID, 0);
	SemRelease(hndlApproDrvSem);
	printf("PausePlaybackChMsg:nValue=%s\n",nValue);
	return msgbuf.ret;
}
...
int SetOSDPrmMsg(int id, OSDPrm* osdprm)
{
	...
	if(id==0)
		...
		msgbuf.cmd = MSG_CMD_SET_OSDPRM4;
	else if(id==4)
		msgbuf.cmd = MSG_CMD_SET_OSDPRM5;
	else if(id==5)
		msgbuf.cmd = MSG_CMD_SET_OSDPRM6;
	else if(id==6)
		msgbuf.cmd = MSG_CMD_SET_OSDPRM7;
	else if(id==7)
		msgbuf.cmd = MSG_CMD_SET_OSDPRM8;
	ptr = (unsigned char*)&msgbuf.mem_info;
...
int SetMCVIP_OSDEnable(unsigned char nValue)
{
	MSG_BUF msgbuf;
	unsigned char* ptr;
	...
	msgbuf.Des = MSG_TYPE_MSG1;
	msgbuf.Src = PROC_MSG_ID;
	msgbuf.cmd = MSG_CMD_SET_MCVIP_OSDENABLE;
	ptr = (unsigned char*)&msgbuf.mem_info;
	*ptr = nValue;
	SemWait(hndlApproDrvSem);
	msgsnd( qid,&msgbuf,sizeof(msgbuf)-sizeof(long),0);/*send msg1*/
