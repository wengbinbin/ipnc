...
typedef enum
{
  ...
  #if 0
  SFIELD_SET_RS485,
  SFIELD_SET_RS485_DEV_ADD,
  SFIELD_SET_RS485_DEV_DEL,
  SFIELD_SET_RS232,
  SFIELD_SET_RS232SPEED,
  SFIELD_SET_RS232DATABIT,
  SFIELD_SET_RS232STOPBIT,
  SFIELD_SET_RS232PARITY,
  SFIELD_SET_RS232STREAMCTRL,
  #endif
  
  SFIELD_SET_PLC_TCP,
  SFIELD_SET_PLC_SERIAL,

  /* Alarm & Storage */
  SFIELD_SET_ALARM_ENABLE,
  SFIELD_SET_EXT_ALARM,
  SFIELD_SET_DARKBLANK,
  ...
  SFIELD_ENABLE_RECCH, ///< .
  SFIELD_GET_PBRECDAY, ///< 
  SFIELD_GET_PBRECHOUR, ///< .
  SFIELD_START_PLAYBACKCH, ///< 
  SFIELD_STOP_PLAYBACKCH, ///< 
  SFIELD_PAUSE_PLAYBACKCH, ///< 
  SFIELD_RESUME_PLAYBACKCH, ///< 
...
//gio
  ...
  SFIELD_SET_PRESETNOTE    ///add by wbb
} SYSTEM_CONTROL;
