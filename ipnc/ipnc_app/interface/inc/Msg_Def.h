...
enum {
	...
	MSG_CMD_SET_CHRECENABLE,//add by sxh
	MSG_CMD_GET_PBRECDAY,//add by sxh
	MSG_CMD_GET_PBRECHOUR,//add by sxh
	MSG_CMD_START_PLAYBACKCH,//add by sxh
	MSG_CMD_STOP_PLAYBACKCH,//add by sxh
	MSG_CMD_PAUSE_PLAYBACKCH,//add by sxh
	MSG_CMD_RESUME_PLAYBACKCH,//add by sxh
	MSG_CMD_PTZ,
	...
	MSG_CMD_SET_OSDPRM6,
	MSG_CMD_SET_OSDPRM7,
	MSG_CMD_SET_OSDPRM8,//add by sxh,
...
enum {
	...
	SYS_MSG_SET_PTZ,
        ...
        #if 0
	SYS_MSG_SET_RS485,
	SYS_MSG_SET_RS485_DEV_ADD,
	SYS_MSG_SET_RS485_DEV_DEL,
	SYS_MSG_SET_RS232,
	SYS_MSG_SET_RS232SPEED,
	SYS_MSG_SET_RS232DATABIT,
	SYS_MSG_SET_RS232STOPBIT,
	SYS_MSG_SET_RS232PARITY,
	SYS_MSG_SET_RS232STREAMCTRL,
	#endif
    
	SYS_MSG_SET_PLC_TCP,
	SYS_MSG_SET_PLC_SERIAL,

	/* Alarm & Storage */
	SYS_MSG_SET_ALARM_ENABLE,
	SYS_MSG_SET_DARKBLANK,
	...
	SYS_MSG_ENALBE_RECCH,///enable rec ch
	SYS_MSG_GET_PBRECDAY,///get pb rec day 
	SYS_MSG_GET_PBRECHOUR,///					add by sxh
	SYS_MSG_START_PLAYBACKCH,///					add by sxh
	SYS_MSG_STOP_PLAYBACKCH,///					add by sxh
	SYS_MSG_PAUSE_PLAYBACKCH,///					add by sxh
	SYS_MSG_RESUME_PLAYBACKCH,///					add by sxh
...
typedef enum {
	...
	FMT_MPEG4_1,
	FMT_MPEG4_2,
	FMT_MPEG4_3, //add by sxh channel,
	FMT_MPEG4_EXT,
	FMT_AUDIO,
	FMT_MAX_NUM
}FrameFormat_t;
...
#define VNF_MASK	0xC0
#define VNF_RESET	0x03
#define PREPR_MASK	0x03
#define PREPR_RESET	0xC0
