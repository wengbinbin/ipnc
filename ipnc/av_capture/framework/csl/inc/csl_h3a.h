...
*/
  typedef struct {
    ...
    Uint16  iirCoeff0[11];      ///< IIR filter coefficient #0, Must be in the range of signed -32 <= value <= 31 +63/64
    Uint16  iirCoeff1[11];      ///< IIR filter coefficient #1, Must be in the range of signed -32 <= value <= 31 +63/64

    Uint8   vfvFir1Coeff[5];    ///< Vertical FV FIR 1 coefficient 0-5
    Uint16  vfvFir1Threshold;   ///< Vertical FV FIR 1 threshold
    Uint16  hfvFir1Threshold;   ///< Horizontal FV FIR 1 threshold

    Uint8   vfvFir2Coeff[5];    ///< Vertical FV FIR 2 coefficient 0-5
...
*/
  typedef struct {
    ...
    CSL_H3aRegsOvly regs;       ///< Register overlay
