...
int DRV_captureTestOpen()
{
  ...
  gDRV_testCtrl.captureConfig.imgsConfig.sensorMode = DRV_CAPTURE_TEST_SENSOR_MODE;//add by sxh 1115
  ...
  gDRV_testCtrl.captureConfig.h3aConfig.numBufAf    = 0;
  ...
  gDRV_testCtrl.captureConfig.ipipeConfig.rszOutConfig[0].width     = 720;
  gDRV_testCtrl.captureConfig.ipipeConfig.rszOutConfig[0].height    = 480;
  ...
  gDRV_testCtrl.captureConfig.ipipeConfig.rszOutConfig[1].width     = 320;
  gDRV_testCtrl.captureConfig.ipipeConfig.rszOutConfig[1].height    = 240;
  ...
  status = DRV_displaySetMode(DRV_DISPLAY_MODE_NTSC);// add by sxh
  if(status!=OSA_SOK)
    goto error_exit;
...
int DRV_captureTestRun()
{
  ...
  DRV_displaySwitchBuf( &gDRV_testCtrl.displayHndl, &gDRV_testCtrl.displayBufId);
