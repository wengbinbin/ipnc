...
int DRV_reszInit()
{
  ...
  gDRV_reszObj.inSrcConfig.isifInType             = CSL_IPIPEIF_ISIF_INPUT_TYPE_YUV;//CSL_IPIPEIF_ISIF_INPUT_TYPE_RAW; //add by sxh 1115
  gDRV_reszObj.inSrcConfig.yuvConvertEnable       = TRUE;//FALSE //add by sxh 1115
