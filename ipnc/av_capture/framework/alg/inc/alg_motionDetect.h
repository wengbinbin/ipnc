...
#define ALG_MOTION_DETECT_MAX_HORZ_REGIONS 	128 //2048 pixels/16
#define ALG_MOTION_DETECT_MAX_VERT_REGIONS 	128 //2048 lines/16
#define ALG_MOTION_DETECT_MAX_REGIONS   	(ALG_MOTION_DETECT_MAX_HORZ_REGIONS*ALG_MOTION_DETECT_MAX_VERT_REGIONS)

//Following values are different thresholds for Sensitivity that can come from UI
#define ALG_MOTION_DETECT_SENSITIVITY_LOWEST_THRESHOLD   	20
#define ALG_MOTION_DETECT_SENSITIVITY_LOW_THRESHOLD         40
#define ALG_MOTION_DETECT_SENSITIVITY_MEDIUM_THRESHOLD   	60
#define ALG_MOTION_DETECT_SENSITIVITY_HIGH_THRESHOLD        80
#define ALG_MOTION_DETECT_SENSITIVITY_HIGHEST_THRESHOLD  	100
...
typedef struct {
	...
	int motionsens;
	int blockNum;
	char windowEnableMap[ALG_MOTION_DETECT_MAX_HORZ_REGIONS][ALG_MOTION_DETECT_MAX_VERT_REGIONS];
...
typedef struct {
    char windowMotionDetected[ALG_MOTION_DETECT_MAX_HORZ_REGIONS][ALG_MOTION_DETECT_MAX_VERT_REGIONS];
