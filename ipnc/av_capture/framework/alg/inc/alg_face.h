...
#define FR_MAX_USER_NO      32     	/* Max no user */
...
#define FR_REG_CONF         300     /* Face recognition registering a user confidence rate */
...
typedef struct {
  ...
  int userID;
  char usrName[ALG_STRING_SIZE];  //Revisit
} ALG_FaceRecogStatus;
