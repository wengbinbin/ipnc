...
int OSA_tskCreate(OSA_TskHndl *pPrc, OSA_TskFncMain fncMain, Uint32 tskPri, Uint32 tskStackSize, Uint32 initState)
{
  ...
  // Stack size is always forced to default as of now
  OSA_assertSuccess( OSA_thrCreate(&pPrc->thrHndl, OSA_tskThrMain, tskPri, OSA_THR_STACK_SIZE_DEFAULT /* tskStackSize */, pPrc) );
