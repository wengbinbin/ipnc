...
//#define __CACHE_DEBUG //add by sxh
...
{
	{
		...
		.start_addr			= 0,
		.start_phy			= 0,
		.size				= 0,//MJPG_CACHE_SIZE,
		.blk_sz				= 1,//MJPG_CACHE_BLK_SIZE,
		.blk_num			= 0,//(MJPG_CACHE_SIZE/MJPG_CACHE_BLK_SIZE),
		.cache_num			= 0,//(MJPG_CACHE_SIZE/MJPG_CACHE_BLK_SIZE),
		.cache 				= NULL,
		.blk 				= NULL,
	...
	},
	{
		...
		.start_addr			= 0,
		.start_phy			= 0,
		.size				= MP4_CACHE_SIZE,//0xB00000,//MP4_CACHE_SIZE,//add by sxh channel
		.blk_sz				= MP4_CACHE_BLK_SIZE,//153*1024,//MP4_CACHE_BLK_SIZE,
		.blk_num			= (MP4_CACHE_SIZE/MP4_CACHE_BLK_SIZE),//(0xB00000)/(153*1024),//(MP4_CACHE_SIZE/MP4_CACHE_BLK_SIZE),
		.cache_num			= (MP4_CACHE_SIZE/MP4_CACHE_BLK_SIZE),//(0xB00000)/(153*1024),//(MP4_CACHE_SIZE/MP4_CACHE_BLK_SIZE),
		.cache 				= NULL,
		.blk 				= NULL,
	},
	{
	...
	},
	{
		...
		.start_addr			= 0,
		.start_phy			= 0,
		.size				= 0xB00000,//MP4_CACHE_SIZE,//add by sxh channel
		.blk_sz				= 153*1024,//MP4_CACHE_BLK_SIZE,
		.blk_num			= (0xB00000)/(153*1024),//(MP4_CACHE_SIZE/MP4_CACHE_BLK_SIZE),
		.cache_num			= (0xB00000)/(153*1024),//(MP4_CACHE_SIZE/MP4_CACHE_BLK_SIZE),
		.cache 				= NULL,
		.blk 				= NULL,
	},
	{
		...
		.start_addr			= 0,
		.start_phy			= 0,
		.size				= 0,//MP4_EXT_CACHE_SIZE,//add by sxh channel
		.blk_sz				= 1,//MP4_EXT_CACHE_BLK_SIZE,
		.blk_num			= 0,//(MP4_EXT_CACHE_SIZE/MP4_EXT_CACHE_BLK_SIZE),
		.cache_num			= 0,//(MP4_EXT_CACHE_SIZE/MP4_EXT_CACHE_BLK_SIZE),
		.cache 				= NULL,
		.blk 				= NULL,
	},
	{
